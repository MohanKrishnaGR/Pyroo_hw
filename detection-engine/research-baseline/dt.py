...
def generate(
    ...
    source=ROOT / "dev/video0",  # file/dir/URL/glob/screen/0(webcam)
    ...
    if view_img:
        windows = []  # remove window handling for Flask streaming
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        class_counts = {}  # create dictionary for metadata
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    # CODE FOR LOOPING AND DISPLAYING
                    # Display class label and confidence score on the frame
...
def index():
    return Response(
        generate(**vars(opt)), mimetype="multipart/x-mixed-replace; boundary=frame"
    )
...
if __name__ == "__main__":
    ...
    # listener = ngrok.forward("192.168.1.13:8080", NGROK_AUTHTOKEN='2bDNhfUzgimIjprjBKoRtLYJnHs_4y1k9bZmBZuhzNkEWZg74')
